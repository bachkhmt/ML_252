...
|:----------|:----:|:------|:--------|
| **Hoàng Xuân Bách** | 2352082 | bach.hoang2407khmt@hcmut.edu.vn | Trưởng nhóm, EDA & Feature Engineering |
| **Nguyễn Việt Hùng** | 2352424 | hung.nguyen@hcmut.edu.vn | Data Preprocessing & Model Training |
| **Trần Văn Hùng** | 2352425 | hung.tran@hcmut.edu.vn | Evaluation & Reporting |
...
**Tên dataset:** [Tên dataset của bạn]  
**Nguồn:** [Link Kaggle/UCI Repository]  
**Kích thước:** X mẫu × Y đặc trưng

### Đặc điểm dữ liệu
- ✓ Có **missing values** (phục vụ thực hành imputation)
- ✓ Có **categorical features** (phục vụ thực hành encoding)
- ✓ Kích thước mẫu đủ lớn cho pipeline có ý nghĩa
- ✓ Bài toán: [Classification/Regression]
...
|:-----------|:----------|:--------------:|
| Hoàng Xuân Bách | EDA, Feature Engineering, Report Writing | 35% |
| Nguyễn Việt Hùng | Data Preprocessing, Model Training | 35% |
| Trần Văn Hùng | Model Evaluation, Visualization, GitHub Setup | 30% |
